...
if [ ! -e 'Fedora-Everything-netinst-x86_64-32-1.6.iso' ]
then echo "downloading ISO and checksums..."
wget 'https://mirror.karneval.cz/pub/linux/fedora/linux/releases/32/Everything/x86_64/iso/Fedora-Everything-netinst-x86_64-32-1.6.iso'
wget 'https://mirror.karneval.cz/pub/linux/fedora/linux/releases/32/Everything/x86_64/iso/Fedora-Everything-32-1.6-x86_64-CHECKSUM'
sha256sum -c 'Fedora-Everything-32-1.6-x86_64-CHECKSUM' || exit 1
fi
echo "mounting ISO..."
fuseiso 'Fedora-Everything-netinst-x86_64-32-1.6.iso' $mountdir
